...
transResults()
{
    static std::unordered_map<
        ...
        {tecHAS_OBLIGATIONS,
         {"tecHAS_OBLIGATIONS",
          "The object cannot be deleted since it has obligations."}},
        {tecTOO_SOON,
         {"tecTOO_SOON",
          "It is too early to attempt the requested operation. Please wait."}},
        {tecBAD_ORACLE_UPDATE,
         {"tecBAD_ORACLE_UPDATE",
          "Could not update the oracle with these values."}},
        {tecORACLE_ASSET_MISMATCH,
         {"tecORACLE_ASSET_MISMATCH", "Oracle asset mismatch."}},
        {tecUNFUNDED_CDP_DEPOSIT,
         {"tecUNFUNDED_CDP_DEPOSIT", "Unfunded CDP deposit"}},
        {tecSTABLECOIN_PROTOTYPE_LIMIT_EXCEEDED,
         {"tecSTABLECOIN_PROTOTYPE_LIMIT_EXCEEDED",
          "Stablecoin prototype limit exceeded"}},
        {tecNO_ORACLE_VALUE, {"tecNO_ORACLE_VALUE", "No oracle value"}},
        {tecSTABLECOIN_ISSUANCE_RATIO,
         {"tecSTABLECOIN_ISSUANCE_RATIO", "Issuance ratio violation"}},
        {tecSTABLECOIN_MAX_ISSUED_EXCEEDED,
         {"tecSTABLECOIN_MAX_ISSUED_EXCEEDED",
          "Max number of stable coins exceeded"}},
        {tecCDP_DRY, {"tecCDP_DRY", "CDP cannot be redeemed against"}},
        {tecSTABLECOIN_UNFUNDED_REDEEM,
         {"tecSTABLECOIN_UNFUNDED_REDEEM", "Stablecoin unfunded redeem"}},
        ...
        {temBAD_STABLECOIN_ISSUANCE_RATIO,
         {"temBAD_STABLECOIN_ISSUANCE_RATIO",
          "Malformed: Bad issuance ratio."}},
        {temBAD_STABLECOIN_LIQUIDATION_RATIO,
         {"temBAD_STABLECOIN_LIQUIDATION_RATIO",
          "Malformed: Bad liquidation ratio."}},
        {temBAD_STABLECOIN_LOAN_ORG_FEE,
         {"temBAD_STABLECOIN_LOAN_ORG_FEE",
          "Malformed: Bad loan origination fee."}},
        {temBAD_STABLECOIN_LIQUIDATION_PENALTY,
         {"temBAD_STABLECOIN_LIQUIDATION_PENALTY",
          "Malformed: Bad deposit fee."}},
        {temBAD_STABLECOIN_LIQUIDATION_PENALTY,
         {"temBAD_STABLECOIN_LIQUIDATION_PENALTY",
          "Malformed: Bad liquidation penalty."}},
