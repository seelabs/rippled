...
CONSTRUCT_TYPED_SFIELD(sfTokenID,               "TokenID",              UINT256,   10);
...
CONSTRUCT_TYPED_SFIELD(sfBuyOffer,              "BuyOffer",             UINT256,   28);
CONSTRUCT_TYPED_SFIELD(sfSellOffer,             "SellOffer",            UINT256,   29);
