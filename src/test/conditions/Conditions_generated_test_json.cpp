...
class Conditions_json_test : public ConditionsTestBase
{
    ...
    testThresh1()
    {
        ...
        auto const prefix1Prefix = "aaa"s;
        auto const prefix1Msg = ""s;
        auto const prefix1MaxMsgLength = 3;
        auto const ed3Msg = ""s;
            ...
            std::move(thresh0Subfulfillments), std::move(thresh0Subconditions));
        {
            auto thresh0EncodedFulfillment =
                ...
                "\x01\x03\xa2\x66\xa4\x64\x80\x20\xd7\x5a\x98\x01\x82\xb1\x0a"
            ...
            auto const thresh0EncodedCondition =
                "\xa2\x2b\x80\x20\x31\xaf\x10\xe1\x68\xba\x56\xab\x38\xbe\xbf"
                "\x27\x06\x54\x13\xc7\x68\x96\xa6\x68\x3c\x53\xd7\x46\xf1\x5a"
                "\x64\x38\xfd\x2a\x6c\x66\x81\x03\x06\x10\x06\x82\x02\x03\x58"s;
            auto const thresh0EncodedFingerprint =
                "\x30\x81\x84\x80\x01\x02\xa1\x7f\xa1\x2b\x80\x20\x34\xc5\x87"
                "\x15\xa9\x08\xa9\xfb\xf3\x41\x58\xc3\x95\x30\x3c\x5d\x4a\xe1"
                "\x4c\x3f\x22\xca\x56\x93\xc3\xe8\x41\x58\xba\x11\xbe\xd2\x81"
                "\x03\x02\x04\x06\x82\x02\x03\x08\xa3\x27\x80\x20\x4d\xd2\xea"
